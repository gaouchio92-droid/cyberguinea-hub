...
const GUIDES: Guide[] = [
  ...
  {
    title: "🚦 TLP — Traffic Light Protocol (FIRST/ENISA v2.0)",
    intro: "Système international de classification du partage d'information. Chaque incident, item de veille, bulletin et rapport porte un niveau TLP qui définit qui peut le voir.",
    roles: ["Tous"],
    steps: [
      "TLP:RED — Destinataire nommé uniquement. Ne pas rediffuser.",
      "TLP:AMBER+STRICT — Réservé à l'organisation émettrice (ARPT-CERT seul).",
      "TLP:AMBER — Organisation et clients/opérateurs concernés (à connaître pour agir).",
      "TLP:GREEN — Communauté de confiance (CERTs partenaires, secteur).",
      "TLP:CLEAR (ex-WHITE) — Diffusion publique sans restriction.",
    ],
    tips: [
      "Sélectionnez le TLP à la création d'un incident, d'un item de veille ou d'un bulletin.",
      "Seuls les bulletins TLP:CLEAR publiés sont visibles sur la page publique /avis.",
    ],
  },
  {
    title: "🎯 IoCs — Indicateurs de Compromission",
    intro: "Référentiel central des indicateurs techniques (IP, domaine, hash, URL, email) observés lors d'incidents ou via la veille. Compatible MISP et STIX 2.1.",
    roles: ["Tous (lecture)", "Analyste / Admin (création)"],
    steps: [
      "Module « Indicateurs (IoCs) » → « Nouvel IoC » : type, valeur, confiance (0-100), TLP, source.",
      "Liez chaque IoC à un incident ou un item de veille (intel) pour la traçabilité.",
      "Filtrez par type, TLP ou tags pour préparer un partage ciblé.",
      "Exportez en MISP JSON, STIX 2.1 ou CSV pour partage avec CERTs partenaires.",
    ],
    tips: [
      "La confiance reflète la fiabilité de la source (50% par défaut).",
      "Les IoCs TLP:RED ne doivent jamais être exportés vers un partenaire externe.",
    ],
  },
  {
    title: "📰 Bulletins & Avis publics (style CERT-FR/ANSSI)",
    intro: "Publication officielle d'alertes, avis de sécurité, bulletins d'information ou IoCs avec référence unique CERT-GN-AAAA-TYPE-NNN.",
    roles: ["Analyste / Admin (rédaction)", "Public (lecture des TLP:CLEAR publiés)"],
    steps: [
      "Module « Bulletins & Avis » → « Nouveau bulletin ».",
      "Choisissez le type : Alerte (urgence), Avis (vulnérabilité), Bulletin (synthèse), IoC (indicateurs).",
      "Rédigez le corps en Markdown, ajoutez systèmes affectés, recommandations et références CVE.",
      "Sélectionnez le TLP — seuls les TLP:CLEAR publiés apparaissent sur la page publique.",
      "Statut : Brouillon → Publié → (Archivé). La référence est générée automatiquement.",
    ],
    tips: [
      "La page publique /avis est accessible sans authentification — utile pour les communiqués nationaux.",
      "Un bulletin Brouillon n'est visible que de son auteur et des admins/analystes.",
    ],
  },
  {
    title: "📞 Contacts 24/7 des opérateurs",
    intro: "Carnet d'astreinte par opérateur (RSSI, NOC, juridique) avec canaux préférés et empreinte PGP. Données sensibles réservées admin/analyste.",
    roles: ["Analyste / Admin"],
    steps: [
      "Module « Opérateurs » → bouton « Contacts 24/7 » sur la fiche opérateur.",
      "Ajoutez nom, rôle, email, téléphone, langues, canal préféré, empreinte PGP.",
      "Activez le badge « Astreinte 24/7 » pour les contacts joignables hors heures ouvrées.",
      "En cas d'incident critique, le carnet est immédiatement consultable depuis la fiche opérateur.",
    ],
    tips: [
      "Vérifiez les contacts au moins une fois par trimestre.",
      "Les emails et téléphones de l'opérateur (champs principaux) restent accessibles uniquement via la fonction sécurisée get_operator_contact.",
    ],
  },
  {
    title: "🏆 Maturité CSIRT (SIM3 light)",
    intro: "Auto-évaluation de la maturité du CERT selon le modèle SIM3 (Security Incident Management Maturity Model) — 4 quadrants : Organisation, Humain, Outils, Process.",
    roles: ["Admin uniquement"],
    steps: [
      "Module « Maturité CSIRT ».",
      "Pour chaque item, attribuez un score de 0 à 4 (0=absent, 4=optimisé/auditable) et joignez des preuves.",
      "Le radar chart visualise instantanément les forces et faiblesses par quadrant.",
      "Refaites l'évaluation chaque semestre pour mesurer la progression.",
    ],
    tips: [
      "Score moyen visé pour un CERT national mature : ≥ 3 sur tous les quadrants.",
      "Documentez les preuves (politiques, procédures, captures) pour faciliter l'audit FIRST/Trusted Introducer.",
    ],
  },
  {
    title: "📖 Glossaire — Acronymes & abréviations",
    intro: "Définition des sigles utilisés dans la plateforme et dans le métier CERT/CSIRT.",
    roles: ["Tous"],
    steps: [
      "ANSSI — Agence Nationale de la Sécurité des Systèmes d'Information (France, référentiel cyber).",
      "APT — Advanced Persistent Threat : groupe d'attaquants avancé, souvent étatique.",
      "ARPT — Autorité de Régulation des Postes et Télécommunications (Guinée).",
      ...
      "CVE — Common Vulnerabilities and Exposures (identifiant standard d'une vulnérabilité).",
      ...
      "FAI — Fournisseur d'Accès Internet (ISP).",
      "FIRST — Forum of Incident Response and Security Teams (réseau mondial de CERTs).",
      "IoC — Indicator of Compromise (indicateur technique d'attaque : IP, hash, domaine…).",
      ...
      "MITRE ATT&CK — Référentiel mondial des tactiques et techniques d'attaque adverse.",
      "MNO — Mobile Network Operator (opérateur mobile).",
      "MTTD — Mean Time To Detect (temps moyen de détection).",
      "MTTR — Mean Time To Respond/Resolve (temps moyen de réponse/résolution).",
      "NIS2 — Directive européenne « Network and Information Security » v2 (2023).",
      "NIST CSF — National Institute of Standards and Technology — Cybersecurity Framework.",
      "NOC — Network Operations Center (centre d'exploitation réseau).",
      "NVD — National Vulnerability Database (base US des CVE).",
      "OIV — Opérateur d'Importance Vitale.",
      "OSE — Opérateur de Services Essentiels (NIS2).",
      "PCA — Plan de Continuité d'Activité.",
      "PCI DSS — Payment Card Industry Data Security Standard.",
      "PGP — Pretty Good Privacy (chiffrement / signature email).",
      "RETEX — Retour d'Expérience (lessons learned).",
      "RLS — Row-Level Security (sécurité ligne par ligne en base).",
      "RSSI — Responsable de la Sécurité des Systèmes d'Information.",
      "SIEM — Security Information and Event Management.",
      "SIM3 — Security Incident Management Maturity Model (modèle de maturité CERT).",
      "SLA — Service Level Agreement (engagement de délai).",
      "SOC — Security Operations Center.",
      "STIX — Structured Threat Information eXpression (format standard d'échange de threat intel).",
      "TLP — Traffic Light Protocol (RED / AMBER+STRICT / AMBER / GREEN / CLEAR).",
    ],
    tips: [
      "Utilisez la recherche en haut pour trouver rapidement un acronyme.",
    ],
  },
];
